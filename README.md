[![npm](https://img.shields.io/npm/v/@lambrioanpm/corrupti-fugit-rem.svg)](https://www.npmjs.com/package/@lambrioanpm/corrupti-fugit-rem) ![downloads](https://img.shields.io/npm/dt/@lambrioanpm/corrupti-fugit-rem.svg) [![CI](https://github.com/lambrioanpm/corrupti-fugit-rem/actions/workflows/ci.yml/badge.svg)](https://github.com/lambrioanpm/corrupti-fugit-rem/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@lambrioanpm/corrupti-fugit-rem/renderer](https://www.npmjs.com/package/@@lambrioanpm/corrupti-fugit-rem/renderer).

## tl;dr

- Install by executing `npm install @lambrioanpm/corrupti-fugit-rem` or `yarn add @lambrioanpm/corrupti-fugit-rem`.
- Import by adding `import { Document } from '@lambrioanpm/corrupti-fugit-rem'`.
...
[Online demo](https://projects.wojtekmaj.pl/@lambrioanpm/corrupti-fugit-rem/) is also available!
...
- [v6.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v6.x/README.md)
- [v5.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v5.x/README.md)
- [v4.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v4.x/README.md)
- [v3.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v3.x/README.md)
- [v2.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v2.x/README.md)
- [v1.x](https://github.com/lambrioanpm/corrupti-fugit-rem/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @lambrioanpm/corrupti-fugit-rem` or `yarn add @lambrioanpm/corrupti-fugit-rem`.
...
```ts
import { pdfjs } from '@lambrioanpm/corrupti-fugit-rem';
...
import { Document, Page } from '@lambrioanpm/corrupti-fugit-rem';
...
Check the [sample directory](https://github.com/lambrioanpm/corrupti-fugit-rem/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/lambrioanpm/corrupti-fugit-rem/wiki/Recipes) in [React-PDF Wiki](https://github.com/lambrioanpm/corrupti-fugit-rem/wiki/).
...
```ts
import '@lambrioanpm/corrupti-fugit-rem/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@lambrioanpm/corrupti-fugit-rem/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@lambrioanpm/corrupti-fugit-rem__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@lambrioanpm/corrupti-fugit-rem__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@lambrioanpm/corrupti-fugit-rem__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@lambrioanpm/corrupti-fugit-rem__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/lambrioanpm/corrupti-fugit-rem/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@lambrioanpm/corrupti-fugit-rem-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@lambrioanpm/corrupti-fugit-rem/contributors.svg?width=890&button=false)
